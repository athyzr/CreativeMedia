...
<section class="pt-32 pb-16 bg-white text-center">
    <div class="container mx-auto px-4">
        <h2 class="text-3xl font-bold text-gray-800 mb-6">Karya Siswa</h2>
        <p class="text-gray-600 max-w-xl mx-auto">Kumpulan karya terbaik dari siswa Creative Media Surabaya.</p>
    </div>
</section>
...
<section class="pb-20 bg-gray-50">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden transform transition duration-300 hover:scale-105 hover:shadow-lg">
                @if($work->image)
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-700 mb-2"><strong>Nama Siswa:</strong> {{ $work->student_name ?? '-' }}</p>
                    <p class="text-gray-600">{{ $work->description ?? 'Tidak ada deskripsi.' }}</p>
                </div>
            </div>
