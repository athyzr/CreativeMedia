@extends('layouts.app') {{-- Sesuaikan layout utama kamu ya --}}
...
<div class="max-w-3xl mx-auto p-6">
    ...
    <div class="text-gray-600 mb-2">Diterbitkan pada {{ $article->created_at->format('d M Y') }}</div>
    <div class="prose max-w-none">
        {!! $article->content !!}
    </div>
    <a href="{{ route('artikel') }}" class="mt-6 inline-block text-cyan-700 hover:underline">← Kembali ke Artikel</a>
</div>
@endsection
